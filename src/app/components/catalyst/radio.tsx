...
const base = [
  ...
  // Focus ring
  'group-data-focus:outline group-data-focus:outline-2 group-data-focus:outline-offset-2 group-data-focus:outline-brand-green',
  // Disabled state
...
>) {
  return (
    <Headless.Radio
      ...
      className={clsx(
        className,
        'group inline-flex cursor-pointer focus:outline-hidden'
      )}
    >
