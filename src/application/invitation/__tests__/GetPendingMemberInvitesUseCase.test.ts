...
import { GetPendingMemberInvitesUseCase } from '../GetPendingMemberInvitesUseCase';
...
describe('GetPendingMemberInvitesUseCase', () => {
  let useCase: GetPendingMemberInvitesUseCase;
  ...
  beforeEach(() => {
    ...
    useCase = new GetPendingMemberInvitesUseCase({
