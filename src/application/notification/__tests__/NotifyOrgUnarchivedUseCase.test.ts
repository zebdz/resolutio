...
import { NotifyOrgUnarchivedUseCase } from '../NotifyOrgUnarchivedUseCase';
...
describe('NotifyOrgUnarchivedUseCase', () => {
  let useCase: NotifyOrgUnarchivedUseCase;
  ...
  beforeEach(() => {
    ...
    useCase = new NotifyOrgUnarchivedUseCase({
