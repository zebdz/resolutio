...
test.describe('Locale Routing Bugs', () => {
  test('should redirect /register to /en/register (default locale)', async ({
    page,
  }) => {
  ...
  test('should redirect /login to /en/login (default locale)', async ({
    page,
  }) => {
  ...
  test('should NOT create double locale prefix when switching from RU to EN', async ({
    page,
  }) => {
  ...
  test('should NOT create double locale prefix when switching from EN to RU', async ({
    page,
  }) => {
  ...
  test('should handle locale switching on nested routes correctly', async ({
    page,
  }) => {
  ...
  test('should redirect root path / to /en (default locale)', async ({
    page,
  }) => {
    await page.goto('/');
    ...
    await expect(
      page.getByRole('heading', { name: 'Take control of your life' })
    ).toBeVisible();
  });
});
